...
async function handleSubmit() {
  ...
  try {
    ...
    const message = error.response?.data?.message || error.response?.data?.detail || 'Failed to create invoice'
...
<template>
  <div class="space-y-6">
    <PageHeader
      title="New Invoice"
      :breadcrumbs="[
        { text: 'Sales', to: { name: 'InvoiceList' } },
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-900">
              <tr>
                ...
                <th class="px-3 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Product</th>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 space-y-3">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-3">
              <div class="flex items-center justify-between">
                ...
                <span class="text-lg font-bold text-emerald-600 dark:text-emerald-400">{{ formatCurrency(grandTotal, auth.branchCurrency) }}</span>
              </div>
            </div>
          </div>
        </div>
