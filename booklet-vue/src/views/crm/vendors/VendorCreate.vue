...
async function handleSubmit() {
  ...
  try {
    ...
    toastStore.show('Vendor created successfully')
    router.push({ name: 'VendorList' })
  } catch (error) {
    console.error('Failed to create vendor:', error)
    const message = error.response?.data?.detail || error.response?.data?.message || 'Failed to create vendor'
...
<template>
  <div>
    <PageHeader title="New Vendor" :breadcrumbs="breadcrumbs" />
