...
def index():
    ...
    return render_template(
        "dashboard/index.html", title="Dashboard", dashboard=dashboard_data
    )
...
@login_required
def stats():
    """Get dashboard stats (JSON for HTMX)"""
...
def subscription():
    ...
    subscription_data, status = api_request(
        "GET", f"/saas/subscription?business_id={business_id}"
    )
